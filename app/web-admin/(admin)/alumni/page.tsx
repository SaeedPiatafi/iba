...
export default function AdminAlumniPage() {
  ...
  const handleViewProfile = (id: number) => {
    router.push(`/web-admin/alumni/${id}`);
  };
                    ...
                    <div className="p-5">
                      ...
                      <div className="grid grid-cols-3 gap-2">
                        <button
                          ...
                          className="inline-flex items-center justify-center px-2 py-2 bg-blue-50 hover:bg-blue-100 text-blue-600 font-medium rounded-lg transition-colors duration-200"
                          title="Edit"
                        >
                          <EditIcon className="w-5 h-5" />
                        </button>
                        <button
                          onClick={() => handleViewProfile(alum.id)}
                          className="inline-flex items-center justify-center px-2 py-2 bg-green-50 hover:bg-green-100 text-green-600 font-medium rounded-lg transition-colors duration-200"
                          title="View Profile"
                        >
                        ...
                        <button
                          ...
                          className="inline-flex items-center justify-center px-2 py-2 bg-red-50 hover:bg-red-100 text-red-600 font-medium rounded-lg transition-colors duration-200"
                          title="Delete"
                        >
